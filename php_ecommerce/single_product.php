<?php 
    ...
    if(isset($_GET["single_product"])){
       $prodata = $obj->product_by_id($_GET);
       $pros = array();
       $prodata = mysqli_fetch_assoc($prodata);
       $pros[] = $prodata;    
    }
    $prodata_cat = $prodata["pdt_cat"];
    $related_info = $obj->related_pro($prodata_cat);
                    ...
                    <div class="container">
                        <nav class="biolife-nav">
                            <ul>
                                ...
                                <li class="nav-item"><a href="category.php?catView=<?= $pro["pdt_cat"]?>" class="permal-link"><?php
                                    foreach($pros as $pro){
                                        echo $pro["pdt_cat"];
                                    }  ?>
                            </a></li>
                                    ...
                                    <div class="sumary-product single-layout">
                                        <div class="media">
                                            <ul class="biolife-carousel slider-for" data-slick='{"arrows":false,"dots":false,"slidesMargin":30,"slidesToShow":1,"slidesToScroll":1,"fade":true,"asNavFor":".slider-nav"}'>
                                                <li><img src="admin/upload/<?= $pro['pdt_img']?>" alt="" width="500" height="500"></li>
                                            </ul>
                                        </div>
                                        <div class="product-attribute">
                                            <h3 class="title"><?= $pro['pdt_name']?></h3>
                                            <div class="rating">
                                            ...
                                            <span class="sku">Sku: #<?= $pro['pdt_id']?></span>
                                            <p class="excerpt"><?= $pro['pdt_des']?></p>
                                            <div class="price">
                                    ...
                                    <!-- related products -->
                                        <div class="product-related-box single-layout">
                                            ...
                                            <ul class="products-list biolife-carousel nav-center-02 nav-none-on-mobile" data-slick='{"rows":1,"arrows":true,"dots":false,"infinite":false,"speed":400,"slidesMargin":0,"slidesToShow":5, "responsive":[{"breakpoint":1200, "settings":{ "slidesToShow": 4}},{"breakpoint":992, "settings":{ "slidesToShow": 3, "slidesMargin":20 }},{"breakpoint":768, "settings":{ "slidesToShow": 2, "slidesMargin":10}}]}'>
                                                    <?php
                                                        while($repro = mysqli_fetch_assoc($related_info)){
                                                    ?>
                                                <li class="product-item">
                                                    <div class="contain-product layout-default">
                                                        <div class="product-thumb">
                                                            <a href="single_product.php?single_product=<?= $repro["pdt_id"]?>" class="link-to-product">
                                                                <img src="admin/upload/<?= $repro["pdt_img"]?>" alt="dd" width="270" height="270" class="product-thumnail">
                                                            </a>
                                                        </div>
                                                        <div class="info">
                                                            <b class="categories"><?= $repro["pdt_cat"]?></b>
                                                            <h4 class="product-title"><a href="single_product.php?single_product=<?= $pro["pdt_id"]?>" class="pr-name"><?= $repro["pdt_name"]?></a></h4>
                                                            <div class="price">
                                                                <ins><span class="price-amount"><span class="currencySymbol">£</span><?= $repro["pdt_price"]?></span></ins>
                                                            </div>
                                                            <div class="slide-down-box">
                                                                <p class="message"><?= $repro["pdt_des"]?></p>
                                                                <div class="buttons">
